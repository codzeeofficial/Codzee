...
import styles from './SiteControlSection.module.css'

export default function SiteControlSection() {
  const capability = capabilitiesContent.capabilities[4]
      ...
      <div className={styles.container}>
        ...
        >
          <div className={styles.kickerRow}>
            ...
            <span className={styles.kicker}>Autonomous Operations</span>
          </div>
