...
import styles from './AccessControlSection.module.css'

export default function AccessControlSection() {
  const capability = capabilitiesContent.capabilities[1]
      ...
      <div className={styles.container}>
        ...
        >
          <div className={styles.kickerRow}>
            ...
            <span className={styles.kicker}>Role Architecture</span>
          </div>
