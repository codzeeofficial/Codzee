...
import styles from './PerformanceMediaSection.module.css'

export default function PerformanceMediaSection() {
  const capability = capabilitiesContent.capabilities[5]
      ...
      <div className={styles.container}>
        ...
        >
          <div className={styles.kickerRow}>
            ...
            <span className={styles.kicker}>Performance Architecture</span>
          </div>
