...
import styles from './PaymentsPlansSection.module.css'

export default function PaymentsPlansSection() {
  const capability = capabilitiesContent.capabilities[2]
      ...
      <div className={styles.container}>
        ...
        >
          <div className={styles.kickerRow}>
            ...
            <span className={styles.kicker}>Commercial Infrastructure</span>
          </div>
